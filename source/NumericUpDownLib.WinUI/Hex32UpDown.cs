namespace NumericUpDownLib.WinUI
{
    ...
    /// </summary>
    public partial class Hex32UpDown : AbstractBaseUpDown<uint>
    {
        #region fields
        /// <summary>
        ...
        {
#if false
            DefaultStyleKeyProperty.OverrideMetadata(typeof(Hex32UpDown),
               new FrameworkPropertyMetadata(typeof(Hex32UpDown)));

            MaxValueProperty.OverrideMetadata(typeof(Hex32UpDown),
                                                  new PropertyMetadata(uint.MaxValue));

            MinValueProperty.OverrideMetadata(typeof(Hex32UpDown),
            ...
            ////		    typeof(Hex32UpDown), new PropertyMetadata(uint.MinValue));
            ////
            ////		AbstractBaseUpDown<uint>.MaxValueProperty.OverrideMetadata(
            ////		    typeof(Hex32UpDown), new PropertyMetadata(uint.MaxValue));
        }

        /// <summary>
        /// Initializes a new instance of the AbstractBaseUpDown Control.
        /// </summary>
        public Hex32UpDown() : base()
        {
            this.DefaultStyleKey = typeof(Hex32UpDown);
            this.MaxValue = uint.MaxValue;
        ...
        /// </summary>
        public override uint SmallChange
        {
            get
            {
                return (uint)GetValue(StepSizeProperty);
            }
            set
            {
        ...
        /// This value should at least be 1 or greater.
        /// </summary>
        public override uint LargeChange
        {
            get
            {
                return (uint)GetValue(LargeStepSizeProperty);
            }
            set
            {
