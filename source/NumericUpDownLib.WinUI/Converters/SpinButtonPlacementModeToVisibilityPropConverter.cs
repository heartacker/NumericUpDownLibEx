namespace NumericUpDownLib.WinUI.Converters
{
    ...
    public sealed class SpinButtonPlacementModeToVisibilityPropConverter : IValueConverter
    {
        #region constructor
        /// <summary>
        /// Class constructor
        /// </summary>
        public SpinButtonPlacementModeToVisibilityPropConverter()
        {
            // set defaults
        ...
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            if (!(value is NumberBoxSpinButtonPlacementMode) && !(value is int))
                return null;
            return ((NumberBoxSpinButtonPlacementMode)value == NumberBoxSpinButtonPlacementMode.Hidden) ? FalseValue : TrueValue;
        }
